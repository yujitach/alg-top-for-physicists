...
and so on.
So, the map $M\to BG$ really just encodes the algebraic data of the patching elements $g_{ij}$ in a topological manner.

(A drawing here would help the understanding.)
...
\subsection{$H^3$ and the anomaly of $1+1$d systems}

\goodbreak

\section{Fermion operators and spinors}

\subsection{Complex fermion operators and the 2-periodicity}

\subsection{Real fermion operators and the 8-periodicity}
