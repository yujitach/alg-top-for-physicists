...
(The name $Pin$ was chosen because $Pin$ should be to $Spin$ as $O$ is to $SO$.)
...
\emph{Pinors} are then simply the ungraded representations of either $\Cliff_\bR(d,1)$ or $\Cliff_\bR(1,d)$.
