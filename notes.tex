...
\begin{figure}[h]
\centering To be drawn
\caption{Manifolds via pasting coordinate patches \label{fig:pasting}}
\end{figure}
...
$\RP^2$ is non-orientable. To see this, recall $\RP^2=S^2/\bZ_2$,
...
They are triangulated manifolds such that
