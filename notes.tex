...
\newmdtheoremenv[backgroundcolor=black!10,linecolor=black!0]{theorem}{Theorem}[section]
\newmdtheoremenv[backgroundcolor=black!3,linecolor=black!0]{example}{Example}[subsection]
\newmdtheoremenv[backgroundcolor=black!0]{exercise}{Exercise}[subsection]
...
\item \textbf{Homology groups:} $H_n(X)$ is the group obtained by considering $n$-dimensional `cycles' 
