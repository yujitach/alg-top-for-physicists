...
\begin{example}
The superfluid Helium-3 A-phase. 
In this case the order parameter, the Cooper pair condensate, takes values in $\bC^3\otimes \bC^3$.
...
\end{equation}
The potential minimum is at $\mathbf{e}_1\otimes (\mathbf{f}_1+ i\mathbf{f}_2)$,
with a certain unbroken subgroup $H\subset G$, which does not have an easy name.
The space of the potential minimum is $G/H$.
\end{example}
