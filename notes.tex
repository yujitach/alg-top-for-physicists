...
some subset of $S$, $T$ and $\tilde T$,
where \begin{itemize}
\item $S$ is unitary, $S^2=1$, and $SU=U^{-1}S$,
\item $T$ is antiunitary, $T^2=1$, and $TU=U^{-1}T$,
\item $\tilde T$ is antiunitary, $\tilde T^2=1$, and $\tilde TU=U\tilde T$.
\end{itemize}
