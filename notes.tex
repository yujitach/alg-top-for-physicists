...
\int N_1 \omega - \int N_2 \omega = \int_{\partial U}\omega=\int U d\omega = 0.
\end{equation}
...
\subsection{de Rham cohomology of $S^n$ and $\CP^n$}
Let us at least  give some examples of nontrivial de Rham cohomology classes.

Take $\CP^n$. Consider two patches given by \begin{equation}
[1:x_2:x_3:\cdots:x_{n+1}]
\end{equation} and \begin{equation}
[y_1: 1: y_3:\cdots:y_{n+1}]
\end{equation} respectively. Recall that the coordinates are related as $y_i = x_i/x_2$, with the convention $x_1=1$ and $y_2=1$. 
There are other patches but they can be treated in the same manner.

Let us consider the 2-form \begin{equation}
\omega= \frac{dx_2\wedge d\bar{x_2} + dx_3\wedge d\bar{x_3} + \cdots + dx_{n+1}\wedge d\bar{x_{n+1}}}{(1+|x_2|^2+\cdots+|x_{n+1}|^2)^2}.
\end{equation} 
