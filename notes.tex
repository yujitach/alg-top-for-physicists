...
As $\alpha\wedge \beta=(-1)^{pq}\beta\wedge \alpha$,
...
A_{(z)} = \frac{1}{2\pi} \frac{1}{2i} \frac{\sum_a (z_a d\bar z_a-\bar z_a dz_a)}{1+\sum_a |z_a|^2}.
\end{equation} 
We can consider similarly \begin{equation}
A_{(w)} = \frac{1}{2\pi} \frac{1}{2i} \frac{\sum_a (w_a d\bar w_a-\bar w_a dw_a)}{1+\sum_a |w_a|^2}
\end{equation}  defined on the 2nd patch.
On the overlap of the two patches, a short computation shows that \begin{equation}
A_{(z)}=A_{(w)} + \frac{1}{2\pi}\frac{1}{2i} (\frac{dw_1}{w_1}-\frac{d\bar w_1}{\bar w_1})
=A_{(w)} + \frac{d\theta_1}{2\pi},
\end{equation}
...
Going to the second patch, we have  \begin{equation}
