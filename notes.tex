...
We have two standard examples.

First, consider $U(1)$ bundles over $S^2$.
We just learned that this is classified by $\pi_1(U(1))=\bZ$.
...
Next, take a simple simply-connected compact Lie group $G$ such as $SU(2)$.
Then $\pi_3(G)=\bZ$,
and therefore principal $G$-bundles over $S^4$ are classified by $\bZ$.

More commonly, we consider principal bundles $P\to \bR^4$ over a flat $\bR^4$,
