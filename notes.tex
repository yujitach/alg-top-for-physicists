...
\newmdtheoremenv[backgroundcolor=black!0,linecolor=black!0]{aside}[definition]{Aside}
...
\begin{proposition}
For all other $n$, the minimal Hopf invariant for a map $f:S^{2n-1}\to S^n$ is two.
\end{proposition}
...
\end{equation}
and the linking number of $f^{-1}(s) \cup f^{-1}(t)$ within $S^3$ can be seen to be $2$, as \begin{equation}
\text{linking number}(\{s\} \times S^{n-1} ,\{t\} \times S^{n-1} )  =0 
\end{equation} and \begin{equation}
\text{linking number}(\{s\} \times S^{n-1} ,S^{n-1}\times \{t\} )  =1.
\end{equation}
